...
public class SearchRec extends HttpServlet {
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "SELECT * FROM bookings WHERE id=" + pid + ";";
			...
			out.println("<body><h1>Bookings</h1>");
			out.println("<hr><br>");
			out.println("<table><tr><th> ID </th><th> NAME </th><th> AGE </th><th> GENDER </th><th> CITY </th><th> CLASS </th><th> DATE OF TRAVEL </th></tr>");
